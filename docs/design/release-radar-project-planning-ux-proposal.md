...
> **Reconciliation note — 2026-08-26.** This proposal remains
> **Proposed / Unapproved**. No polished screenshot is eligible while its
> Project Plan/Phase Board boundary overlaps the separate all-phase Work Board
> proposal and the coupled route, goal-link, History/Activity, and navigation
> decisions remain unresolved. `docs/delivery/progress.md` is authoritative for
> the gate and sequencing. This note does not revise the historical v5 design.
...
`docs/design/release-radar-ux-redesign-study.md` now records a separate
Goals/Work Board/History owner-review proposal. It remains unapproved and
conflicts with accepted one-to-one goal identity, the accepted phase-scoped
Phase Board, and this proposal's decision to retain Activity. It therefore
does not control this Project Plan proposal or unlock screenshots.
