...
## 4. Truthful scope: Recorded Project Plan
...
## 5. Formal planning authority and owner-mediated request loop
...
The visible UX should offer **Copy planning request** from an authoritative planned-work or phase detail. This mirrors the truthful onboarding handoff boundary:

- It copies a path-free prompt containing only the visible project/work identity and requested planning outcome.
- It does not launch, contact, paste into, or submit to Codex.
- It does not create a phase, change lifecycle, assign work, or mark a request pending.
- It states: “Copied. No request was sent; paste this into a Codex task rooted at the project folder.”
- The exact prompt content and technical clipboard seam are deferred.
...
## 6. Phase taxonomy: owner-facing Gate-1 choice
...
## 7. Semantic identity continuity
...
## 8. Content responsibility and proposed information architecture
...
## 11. Recommended Project Plan composition
...
| Loaded-empty Recorded Project Plan | Completed project load succeeded; 0 phases and 0 unscheduled work; no unresolved candidate flag | “Recorded Project Plan is empty” with verified 0 counts | Copy a planning request or open existing review context if relevant | Do not claim the whole repository has no planned work |
| No Current phase, no recorded work | One or more recorded phases, 0 recorded work, no phase explicitly Current | Show phases grouped by explicit lifecycle; “No current phase recorded” | Select a phase for read-only detail/request | Do not promote a phase |
...
- Exactly one route exposes selected visual treatment and the accessibility selected trait.
...
Existing sidebar accessibility defects are out of scope for this design revision. They establish constraints for new navigation but are not presented as fixes here.

## 15. Goals / History boundary
...
## 16. Recovery, audit, and archive implications
...
## 18. Gate-1 owner decision sheet: visible UX only
...
| UX-10 | Minimum owner request loop | Path-free Copy planning request; copied but not sent | Approve / Revise / Defer |
...
## 19. Deferred technical decision register
...
## 20. Reviewer outcome matrix

| Review role | v1 outcome | v2 disposition |
|---|---|---|
| Planning | REVISE — 8 Required | Recorded-plan boundary, authority loop, taxonomy, identity, IA responsibilities, interaction, state matrix, and gate packaging added |
| Architecture | Conditional GO, not gate-ready — 6 Required | Formal semantic contracts defined; exact representation/transport/migration/archive decisions deferred |
| QA | HOLD — 8 Required | Count formulas, mutually exclusive state classes, focus/keyboard behavior, compact model, failure truth, and acceptance-visible decisions specified |
| TPM | Conditional GO — 6 Required | Scope labels, default emphasis, phase taxonomy, owner decisions, exclusions, and non-overlapping responsibilities pinned |
| Delivery Management | NO-GO packaging — 9 Required | Metadata, artifact register, evidence manifest, reviewer matrix, resolution log, gate sheet, deferred register, and explicit gate statement added |
| Security/Privacy | Conditional pass, not gate-ready — 6 Required | Authority, no-auto-action request flow, audit/recovery/unknown-outcome, archive, and distinct folder/Codex/store boundaries added |

No reviewer outcome is treated as owner approval.

## 21. Required-finding resolution and disagreement log
