...
- **No Current phase:** Overview says “No current phase recorded,” still shows Recorded Project Plan coverage and View Project Plan, and offers no Current-board launch.
...
These failures support the owner-directed separation of jobs: Overview becomes an explicitly scoped executive snapshot, Project Plan becomes the planning-structure surface, and Phase Board remains scoped to one selected phase. This v4 remains Proposed / Unapproved.
...
- Overview says **No current phase recorded**, retains Recorded Project Plan coverage and **View Project Plan**, and omits **Open Current Phase Board**.
...
| Overview | Executive answer to “How is this project doing right now?”: explicit Current phase, current-phase active work/attention, compact goal context, recorded-plan coverage/completeness, and quick entry actions | “Overview · current-phase health and recorded-plan coverage” |
...
| Current-phase active work | Backlog + In progress + Needs review + Blocked work in the explicit Current phase |
| Current-phase attention | Needs review + Blocked work in the explicit Current phase |
...
| Work outside Current phase | Unscheduled work plus scheduled work in all non-Current phases |
...
### Default flow and launch actions
    ...
    Overview
    → View Project Plan
    → Open Current Phase Board (only when explicit Current exists)

    Project Plan
    → select phase
    → Return or Open Phase Board

    Phase Board
    → Dependencies for the same phase/ticket context

Overview is not a plan-selection surface. **View Project Plan** moves focus to the Project Plan heading and initial/remembered selection. **Open Current Phase Board** moves focus to the Current board heading. When no Current phase exists, Overview says “No current phase recorded,” retains coverage and View Project Plan, and omits Open Current Phase Board.
...
- Opening Phase Board from Project Plan preserves that phase; returning restores selection and focus to the originating phase row.
- Opening Current Phase Board from Overview uses only the explicit Current phase; returning restores focus to the Overview launch action.
...
- Returning from Dependencies restores the same board phase and ticket focus.
...
2. Current-phase executive cards: Current phase, current-phase active work, current-phase attention.
3. Recorded-plan coverage cards: Recorded phases, Unscheduled work, Work outside Current phase.
...
| Loaded-empty Recorded Project Plan | Completed load succeeded; 0 phases and 0 unscheduled work; no unresolved flag | Verified-zero coverage, no Current phase, View Project Plan; no Current-board action | Empty plan with header Copy project planning request | View Project Plan or copy project request | Do not claim the repository has no planned work or a request was submitted |
| No Current phase, no recorded work | Recorded phases exist, 0 recorded work, none Current | “No current phase recorded,” phase/coverage counts, View Project Plan; no Current-board action | Show lifecycle groups and header request action | View Project Plan | Do not promote a phase |
| No Current phase, recorded work exists | Recorded work exists but none Current | “No current phase recorded,” project-wide coverage/attention warning, View Project Plan; no Current-board action | Show all groups and Unscheduled; any recorded phase may open read-only | View Project Plan or select a phase there | Do not infer Current from lanes/activity |
| Empty Current phase | Exactly one Current phase exists with 0 assigned work | Name Current, active/attention 0, outside-work/coverage, View Project Plan, Open Current Phase Board | Current group expanded; its phase row shows 0 recorded work, with the board owning five verified-zero lanes | Open Current Phase Board or View Project Plan | Do not imply Recorded Project Plan is empty |
| Incomplete Recorded Project Plan | Load succeeded and unresolved relevant candidates exist | Explicit Current or no-Current snapshot plus prominent “May be incomplete · N candidates” and View Project Plan | Recorded plan plus same incomplete signpost; candidates excluded | Open Needs Review or View Project Plan | Do not include candidates in counts or hide no-Current truth |
| Mature multi-phase | Current exists; recorded work exists; no higher-priority state applies | Current health plus Recorded phases, Unscheduled, outside-Current, attention, goal context, View Project Plan, and Open Current Phase Board | Full grouped plan; Current expanded, Completed collapsed | View Project Plan or Open Current Phase Board | Do not present Overview as the whole plan or hide other groups |
...
- 96-point rail.
- Overview is a single-column executive summary with coverage cards/rows, compact goal context, View Project Plan, and conditional Open Current Phase Board; it never becomes a second plan list.
...
- Project Plan’s Open Phase Board and the board’s Back to Project Plan remain directly reachable.
...
- View Project Plan moves focus to the Project Plan heading and restores its remembered selection when valid.
- Open Current Phase Board moves focus to the Current board heading, then selected lane/card if present.
...
| UX-15 | Overview contents and limits | Current-phase health + recorded-plan coverage + direct actions; no plan lists, relationships, or inspector | Confirm / Revise / Defer |
...
## 21. Reviewer outcome matrix — v4 focused re-review pending

| Review role | Prior recorded outcome | v4 focused re-review status |
|---|---|---|
| Planning | v1 REVISE; v2/v3 closure work recorded | **Pending focused re-review** of retained Overview, Project Plan sibling scope, revised flows, and Gate-1 decisions |
| Architecture | v1 Conditional GO, not gate-ready; v2/v3 semantic deferrals recorded | **Pending focused re-review**; no prior GO carries automatically to the added sibling route/content boundary |
| QA | v1 HOLD; v2/v3 behavioral closure work recorded | **Pending focused re-review** of Overview counts/states/actions, no-Current behavior, responsive layout, and focus return |
| TPM | v1 Conditional GO; v2/v3 scope closure work recorded | **Pending focused re-review** of non-overlapping surface jobs and route cost |
| Delivery Management | v1 NO-GO packaging; v2/v3 packaging artifacts recorded | **Pending focused re-review**; v4 remains Proposed / Unapproved and unlocks no packaging |
| Security/Privacy | v1 Conditional pass, not gate-ready; v2/v3 authority boundaries recorded | **Pending focused re-review**; Overview adds no mutation authority but its data-scope truth requires confirmation |
...
| 5. Content/IA | Overview retained as default executive snapshot; Project Plan added as sibling; every responsibility and scope assigned without list/inspector duplication | Revised by owner direction; pending focused v4 re-review |
...
| 19. Owner-directed Overview retention | Overview remains default executive snapshot; Project Plan is a sibling; state, flow, responsive, focus, alternatives, and Gate-1 records revised | Incorporated on 2026-08-25; pending final owner approval and focused reviewer re-review |

### Explicit disagreement rulings

- Approach A is now **Overview + Project Plan + scoped Phase Execution**. Its Overview retention is owner-directed, but the complete v4 remains Proposed / Unapproved until final Gate-1 approval.
...
Approval of this v4 unlocks only the polished-screenshot design stage. It does not authorize an implementation plan, code change, database change, MCP or bridge change, migration, phase assignment, import/export implementation, repository write, production-artifact mutation, packaging, installation, or deployment.

Nothing in this document is Done or Accepted. The 2026-08-25 owner direction to retain Overview is not final v4 approval. Prior reviewer outcomes do not carry automatically, and reviewer approval is not owner approval. The owner must explicitly approve the complete Gate-1 visible UX before any polished screenshot is created.
