# Historical delivery record through MDCP M6B

Historical and non-authoritative. Preserved from the completed M6B checkpoint;
use `docs/delivery/progress.md` for current state and authorization.
