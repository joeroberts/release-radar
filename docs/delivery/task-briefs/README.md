...
| rr-recovery-ancestry-repair-brief-2026-09-21 | [docs/delivery/task-briefs/2026-09-21-recovery-ancestry-repair.md](2026-09-21-recovery-ancestry-repair.md) | document | controlling &#40;delivery.recovery-ancestry-repair&#41; | active | none | none |
...
## Leaf collection: delivery.task-briefs.2026-09-14-outcome3-runtime-enforcement

- Path: [docs/delivery/task-briefs/2026-09-14-outcome3-runtime-enforcement](2026-09-14-outcome3-runtime-enforcement)
- Purpose: Outcome 3 runtime enforcement assessment; progress controls authorization
- Allowed contents: Controlling task brief
- Prohibited contents: Owner data and credentials; Temporary build output
- First read: [rr-outcome3-runtime-enforcement-brief-2026-09-14](2026-09-14-outcome3-runtime-enforcement/brief.md)
- Archive destination: [delivery.archive](../archive)
- Historical boundary: archived artifacts are non-authoritative.
...
## Leaf collection: delivery.task-briefs.2026-09-16-outcome3-execution-setup

- Path: [docs/delivery/task-briefs/2026-09-16-outcome3-execution-setup](2026-09-16-outcome3-execution-setup)
- Purpose: Outcome 3 deterministic execution setup, owned lifecycle, recovery and source package identity; progress controls authorization
- Allowed contents: Controlling implementation brief
- Prohibited contents: Owner data and credentials; Temporary build output
- First read: [rr-outcome3-execution-setup-brief-2026-09-16](2026-09-16-outcome3-execution-setup/brief.md)
- Archive destination: [delivery.archive](../archive)
- Historical boundary: archived artifacts are non-authoritative.
