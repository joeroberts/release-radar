...
public struct RecognizedPluginCapability: Equatable, Sendable {
    ...
    public static let known = [
        ...
        Self(
            ...
            normalizedPackageDigest: "8f23498996d2beb1994db711d39527ef42a96ffab6344d1976e5e18f925e90eb",
            sharedExecutionStandardVersions: [1]
        ),
        Self(
        ...
        Self(
            manifestVersion: "0.1.17",
            normalizedPackageDigest: "94d7c1c3c506e3b62f7710e7e84df8ad4fc671b9029d06b1f0369b2882230a07",
            sharedExecutionStandardVersions: [1]
        ),
        Self(
        ...
        Self(
            manifestVersion: "0.1.20",
            normalizedPackageDigest: "cb4863f28b85e31536cf61fae29c4062602152867ab3c66be98547055f7b5d5d",
            sharedExecutionStandardVersions: [1]
        ),
        Self(
            manifestVersion: "0.1.21",
        ...
        Self(
            manifestVersion: "0.1.28",
            normalizedPackageDigest: "c79d9b7d79bf24c0d11a4e2caf74cf4901b5cd4ae4962dcc7ca160ff8f97cfcd",
            sharedExecutionStandardVersions: [1]
        ),
        Self(
            manifestVersion: "0.1.29",
            normalizedPackageDigest: "5c6ae4bac785fab77e8c2c27f8c8aae86bf4e15fd8774e6e147351722939e10d",
            sharedExecutionStandardVersions: [1]
        ),
        Self(
            manifestVersion: "0.1.30",
            normalizedPackageDigest: "58b26787e6f108a0de692b7aafda116d7c0918ce2cdfe279d54603eeeadea182",
            sharedExecutionStandardVersions: [1]
        ),
        Self(
            manifestVersion: "0.1.32",
            normalizedPackageDigest: "959f091c34d08eaca22267e08ea306db1ee11d66a4fd3948abaca162f4f93a48",
            sharedExecutionStandardVersions: [1]
        ),
    ]
